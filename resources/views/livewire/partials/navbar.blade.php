            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium {{ Request()->is('/') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6"
                            href="/" aria-current="page">Home</a>

                        <a wire:navigate
                            class="font-medium hover:text-gray-400 {{ Request()->is('categories') ? 'text-blue-600' : 'text-gray-500' }} py-3 md:py-6"
                            href="/categories">
                            Categories
                        </a>
                        ...
                        <a wire:navigate
                            class="font-medium flex items-center {{ Request()->is('cart') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6"
                            href="/cart">
